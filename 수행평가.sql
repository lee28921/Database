# 고객
INSERT INTO `Customer` (`cust_jumin`,`cust_name`,`cust_addr`,`cust_birth`,`cust_phnum`,`cust_job`) 
						VALUES ('760121-1234567','정우성','서울','1976-01-21','010-1101-7601','배우');
INSERT INTO `Customer` (`cust_jumin`,`cust_name`,`cust_addr`,`cust_birth`,`cust_phnum`,`cust_job`) 
						VALUES ('750611-1234567','이정재','서울','1975-06-11','010-1102-7506','배우');
INSERT INTO `Customer` VALUES ('890530-1234567','전지현','대전','1989-05-30','jjh@naver.com','010-1103-7904','자영업');
INSERT INTO `Customer` VALUES ('790413-1234567','이나영','대전','1979-04-13','lee@naver.com','010-2101-8905','회사원');
...
INSERT INTO `Customer` (`cust_jumin`,`cust_name`,`cust_addr`,`cust_birth`,`cust_phnum`,`cust_job`) 
						VALUES ('721128-1234567','유재석','부산','1972-11-28','010-6101-7211','개그맨');
INSERT INTO `Customer` (`cust_jumin`,`cust_name`,`cust_addr`,`cust_birth`,`cust_phnum`,`cust_job`) 
						VALUES ('920907-1234567','강호동','부산','1992-09-07','010-7103-9209','개그맨');
...
INSERT INTO `Card` (`card_no`,`cust_jumin`,`card_register_date`,`card_limit_money`,`card_approve_date`,`card_type`) 
	VALUES ('2711-1001-1004','660912-1234567','2020-04-13',1000000,'2020-04-13','credit');
INSERT INTO `Card` VALUES ('2611-1001-1005','840615-1234567','1011-1002-1005','2020-09-12',1500000,'2020-10-10','check');

INSERT INTO `Card` VALUES ('2781-1001-1006','651021-1234567','1011-1002-1006','2020-09-12',10000000,'2020-08-15','check');
INSERT INTO `Card` VALUES ('2345-1001-1007','721128-1234567','1011-1001-1007','2020-10-21',2000000,'2020-07-25','check');
INSERT INTO `Card` (`card_no`,`cust_jumin`,`card_register_date`,`card_limit_money`,`card_approve_date`,`card_type`) 
	VALUES ('2221-1001-1008','920907-1234567','2020-10-21',5000000,'2020-11-15','credit');
INSERT INTO `Card` VALUES ('2144-1001-1009','891209-1234567','1011-1001-1009','2020-11-28',1000000,'2020-12-10','check');
INSERT INTO `Card` (`card_no`,`cust_jumin`,`card_register_date`,`card_limit_money`,`card_approve_date`,`card_type`) 
	VALUES ('2789-1001-1010','770314-1234567','2020-09-07',1000000,'2020-10-10','credit');
	
# 예금계좌 거래내역
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1001','입금','2월 정기급여',3500000,'2020-02-10 12:36:12');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1003','출금','ATM 출금',300000,'2020-02-10 12:37:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1002','입금','2월 급여',2800000,'2020-02-10 12:38:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1007','출금','2월 공과금',116200,'2020-02-10 12:39:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1002-1005','출금','ATM 출금',50000,'2020-02-10 12:40:21');
	
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1007','입금','홍길동 이체',400000,'2020-02-10 12:41:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1007','출금','2월 관리비',145000,'2020-02-10 12:42:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1002','입금','홍길동 입금',200000,'2020-02-10 12:43:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1001-1009','입금','연말정산 환급',112000,'2020-02-10 12:44:21');
INSERT INTO `Transaction` (`trans_acc_id`,`trans_type`,`trans_message`,`trans_money`,`trans_date`) 
	VALUES ('1011-1002-1006','출금','ATM 출금',30000,'2020-02-10 12:45:21');
...
# 5. 카드종류가 신용카드인 고객에 대한 모든 정보(고객명, 고객주소, 고객생년월일, 고객이메일, 고객전화번호, 고객직업) 조회
